...
busMark = {
     ...
     44208 : {'buloc':(kx+m*11,ky-n*5./3.)}, #Burnpur
     ...
     44117 : {'buloc':(kx+m*6,ky-n*6),'buoffset':(-2,0,90)}, #putki
     ...
     44129 : {'buloc':(kx-m,ky-n*6),'buoffset':(-20,0,0)}, #northkaranpura
     ...
     44138 : {'buloc':(kx+m*3,ky-n*6),'buoffset':(-2,0,90)}, #biada
